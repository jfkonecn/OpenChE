    ...
    public class UnitCategoryCollection : CategoryCollection<Unit>
    {
        ...
        internal static void BuildAllUnits()
        {
            ...
            _AllUnits.Children.Add(
                ...
                {
                    new UnitCategory.UnitCategoryElement(LibraryResources.Pressure, -1)
                })
                {
            ...
            _AllUnits.Children.Add(
                ...
                new UnitCategory.UnitCategoryElement[]
                {
                    new UnitCategory.UnitCategoryElement(LibraryResources.Length, 2)
                })
            {
            ...
            _AllUnits.Children.Add(
                ...
                new UnitCategory.UnitCategoryElement[]
                {
                    new UnitCategory.UnitCategoryElement(LibraryResources.Temperature, -1)
                })
                {
            ...
            _AllUnits.Children.Add(
                ...
                new UnitCategory.UnitCategoryElement[]
                {
                    new UnitCategory.UnitCategoryElement(LibraryResources.Length, 3)
                })
            {
                    Children =
                    {
            ...
            _AllUnits.Children.Add(
                    ...
                    new UnitCategory.UnitCategoryElement[]
                    {
                        new UnitCategory.UnitCategoryElement(LibraryResources.Volume, 1),
                        new UnitCategory.UnitCategoryElement(LibraryResources.Time, -1)
                    })
                {
                });

            _AllUnits.Children.Add(new UnitCategory(LibraryResources.Density, new UnitCategory.UnitCategoryElement[]
                    {
                        new UnitCategory.UnitCategoryElement(LibraryResources.Mass, 1),
                        new UnitCategory.UnitCategoryElement(LibraryResources.Volume, -1)
                    })
            {
            ...
            _AllUnits.Children.Add(new UnitCategory(LibraryResources.SpecificVolume, new UnitCategory.UnitCategoryElement[]
            {
                new UnitCategory.UnitCategoryElement(LibraryResources.Mass, -1),
                new UnitCategory.UnitCategoryElement(LibraryResources.Volume, 1)
            })
            ...
            _AllUnits.Children.Add(new UnitCategory(LibraryResources.Enthalpy, new UnitCategory.UnitCategoryElement[]
                    {
                        new UnitCategory.UnitCategoryElement(LibraryResources.Energy, 1),
                        new UnitCategory.UnitCategoryElement(LibraryResources.Mass, -1)
                    })
            {
            });

            _AllUnits.Children.Add(new UnitCategory(LibraryResources.Entropy, new UnitCategory.UnitCategoryElement[]
                {
                    new UnitCategory.UnitCategoryElement(LibraryResources.Energy, 1),
                    new UnitCategory.UnitCategoryElement(LibraryResources.Mass, -1),
                    new UnitCategory.UnitCategoryElement(LibraryResources.Temperature, -1)
